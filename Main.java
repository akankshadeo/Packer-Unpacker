...
class Login extends Template implements ActionListener, Runnable
{
    ...
    Login()
    {
        ...
        TopLabel.setText("AK's Packer Unpacker : Login");
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        if(ae.getSource() == SUBMIT)
        {
            if(Validate(value1,value2) == false)
            {
                text1.setText("");
                text2.setText("");
                JOptionPane.showMessageDialog(this, "Short username", "AK's Packer Unpacker", JOptionPane.ERROR_MESSAGE);
            }
            ...
            else
            {
                ...
                if(attemp == 0)
                {
                    JOptionPane.showMessageDialog(this, "Number of attempts finished", "AK's Packer Unpacker", JOptionPane.ERROR_MESSAGE);
                    this.dispose();
                    System.exit(0);
                } 
